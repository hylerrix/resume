  ...
  return (
    <header className="content-hd">
      ...
      <section className="info">
        <h2>男 / 1997.10</h2>
        <h3>本科 / 2019 年毕业 · 两年工作经验</h3>
        <h3>西安邮电大学 · 软件工程</h3>
      </section>
      <section className="contact">
        <ul>
          <li><a href="http://hanyile.com" target="_blank"><span className="contact-link">hanyile.com</span><i className="iconfont icon-homepage"></i></a></li>
