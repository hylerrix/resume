      ...
      <div className="item">
          ...
          <div className="item-bd">
            <p className="section-content">
              ...
              其中重点且独立负责迁移 <strong>CMP 全栈微服务同构架构</strong> 项目集，接入弹性云与诸多滴滴中台，并成功部署到国内和美东闭环环境上；
        ...
        <div className="item">
          ...
          <div className="item-bd">
            <p className="section-content">
              ...
              在<strong>从硅到云守护网联汽车安全</strong>的全生命周期创业理念中，定位于前端架构师，重点开发和维护一款核心 Sass 版安全建模产品——<strong>御织</strong>。
              该产品基于最新的国内外车联网安全法规如 <strong>R155</strong>等强标，在一众 <strong>Tara 分析工具</strong>创业竞品中脱颖而出，赢得诸多技术奖项。
              技术栈包括但不限于 <strong>X6</strong>、<strong>Formily</strong>、<strong>React Flow</strong>、<strong>EventEmitter</strong> 等。
              目前核心客户已洽谈锁定，紧张地筹备下一轮融资中。
            </p>
          </div>
        </div>
      </div>
