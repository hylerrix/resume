  ...
  return (
    <section className="skill">
      ...
      <div className="section-sub-title">
        Github - Follower: 430+, Commit & PR & Issues: 1200+
      </div>
        ...
        <ul className="section-list">
          <li>
            <p className="section-content">
              ...
              注重<strong>代码可维护性</strong>，有超<strong>4 年</strong>的大前端开发经验。
          ...
          <li>
            <p className="section-content">
              <i className="iconfont icon-dot"></i>
              熟悉<strong>Node.js</strong>为主的后端开发基础技能，围绕 <strong>Koa</strong>、<strong>Nest.js</strong> 等生态写过简单的接口。
          ...
          <li>
            <p className="section-content">
              ...
              并以<strong>Mac OS</strong>、<strong>VS Code</strong>、
              <strong>Postman</strong>、<strong>Burp Suit</strong>、<strong>Draw IO</strong>、<strong>Set App</strong>、<strong>ChatGPT</strong> 等作为日常开发工具进行高效率工作，熟悉开发调试工具的使用。
            </p>
          </li>
          <li>
            <p className="section-content">
              <i className="iconfont icon-dot"></i>
              坚持写作，热爱分享，曾有 80+ 篇<strong>原创技术博文</strong>，10+ 篇<strong>英文技术文章翻译</strong> 发布在国内各大平台，
              有良好的<strong>知识管理能力</strong>。目前重度使用 <strong>AirTable</strong>, <strong>Notion</strong> 和 <strong>Lark Base</strong> 沉淀了大量的结构化知识。逐步迈向更自动化、更开放共建的低代码数据管理范式中。
            </p>
          </li>
          <li>
            <p className="section-content">
