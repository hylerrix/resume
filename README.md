...
|2018-03-07|滴滴出行|投递简历|投递至滴滴出行汽车资产管理中心邮箱账号，等待回复|
|2018-03-07|tap4fun|投递简历|官网招聘入口投递 PDF 版简历，等待后续消息|
|2018-03-07|拼多多|填写在线简历|官网招聘入口填写在线简历，只招 18 届应届，理论上白填|
|2018-03-07|梅沙科技|投递简历|简历由公司实验室毕业学长投递给 HR，等待面试消息|
|2018-03-08|梅沙科技|约定面试时间|与梅沙科技前端组长约定在 14 号上午面试|
|2018-03-13|百度|
360
网易
今日头条
...
> 第二阶段，过几天投递
> |2018-03-07|网易|填写在线简历|填写实验室学长内推码 g1XUyoqg，等待后续消息|√!|
>
> * 天猫、美图秀秀、快手、喜马拉雅、唯品会、蘑菇街、美拍、爱奇艺、优酷、百词斩、瓜子车(liufeixia@guazi.com，3 月内）、今日头条(内推码：STF4TT7)、五八同城
> * 谷歌(jobs@google.com)、微软、脸书、Netflix、...
...
|2016.07|2016.07|唯依蛋糕|为期两个月，学习使用 Node.JS、ReactJS、Webpack、MongoDB 构建全栈项目，并开源至 Github 中。后期持续对其进行代码重构、逻辑完善、页面美化。|Node 全栈开发|
|2017.05|2017.05|畅校园宣讲会|单个页面项目，调用无限下拉接口，|前端开发|
...
|2017.10|至今|西邮前端圈|结合自身社区优势，为西邮人量身搭建了这一前端圈社群。开发成员横跨多个专业，使用Git Flow 工作流程进行协作开发，并通过 Git Hooks 脚本自动触发服务器更新。使用少量的Express 框架，通过 pm2 进程管理工具，将应用部署到了线上 CentOS 系统的 Nginx 服务器上，并采取了反向代理策略提供良好的域名访问体验。|全栈开发|
|2017.11|2017.11|CreatShare 实验室官网|适配各大主流浏览，采用 Floxbox 布局和 srcset 等 HTML5/CSS3 新技术，完整地实现了移动端和桌面端两套高保真方案。|前端开发|
|2017.12|2017.12|四六级成绩预测 H5||前端开发|
